...
| 11 | **ADR: responsive PWA over a native wrapper**, and the `vite-plugin-pwa` exception to the hand-rolled-implementations preference — [ADR-0023](../adrs/adr-0023.md) | S | 8 |
